/* ==========================================================================
   Chapter Vision docs — shared shell: sidebar, search, TOC, prev/next.
...
(function () {
  ...
  var MANIFEST = [
    {
      ...
      pages: [
        ...
        { id: "install-and-setup", file: "install-and-setup.html", title: "Install & set up", desc: "System requirements and first-launch setup for Chapter Studio on macOS and Chapter Vision on visionOS.", keywords: "install setup requirements macos visionos download launch welcome recent" },
        { id: "studio-workspace", file: "studio-workspace.html", title: "The Studio workspace", desc: "Chapter Studio's editing window: the source and program monitors, left panel, inspector, timeline, tools, viewer navigation and immersive guides.", keywords: "workspace window panels layout viewer source previewer inspector toolbar tools shortcuts camera orbit immersive guides overlays welcome" },
    ...
    },
    {
      section: "Animation",
      pages: [
        { id: "animation-overview", file: "animation-overview.html", title: "Animation overview", desc: "Segment-level animation tracks: ten channels per entity, absolute-time keys, and one evaluator everywhere.", keywords: "animation overview tracks channels keyframe segment pose opacity" },
  ...
  if (shell) {
    var markSvg =
      '<img class="mark" src="/assets/icon-256.png" alt="Chapter Vision icon" style="border-radius:50%">';
    ...
    shell.innerHTML =
      ...
      '<a class="brand" href="/">' + markSvg + 'Chapter&nbsp;Vision <span class="docs-tag">Handbook</span></a>' +
